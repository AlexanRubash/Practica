    ...
    <div id="author${authorId}">
        ...
        <div style="display: flex; margin-top: 20px">
            <div style="width: 47%">
                ...
                <input type="number" id="author-number" name="authorNumber[]" min="0" required><br><br>

                <label for="authorFIO" style="margin-top: 22px">Фамилия, имя, отчество:</label>
                <input type="text" id="author-fio" name="authorFIO[]" required><br><br>

                <label for="author-year-birh">Год рождения:</label>
                <input type="number" id="author-year-birh" name="authorYearBirh[]" min="1900" max="${new Date().getFullYear()}" step="1"  required><br><br>

                <label for="authorWorkplace">Место работы:</label>
                <input type="text" id="author-workplace" name="authorWorkplace" required><br><br>
            </div>

            <div style="width: 50%; margin-left: 3%">
                <label for="author-work-position">Должность:</label>
                <input type="text" id="author-work-position" name="authorWorkPosition[]" required><br><br>

                <label for="contribution">Обоснование конкретного творческого вклада:</label>
                <input type="text" id="contribution" name="contribution[]" required><br><br>

                <label for="percent-contribution">% авторского вклада:</label>
                <input type="number" id="percent-contribution" name="percentContribution[]" min="0" max="100" step="1" required><br><br>
            </div>
        </div>
    </div>
    `;
