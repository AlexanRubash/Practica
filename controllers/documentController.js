...
module.exports = {
    ...
    async addDocument (req, res) { 
        try {
            ...
            const supplements = documentService.createSupplements(data.supplements, req.files);
            ...
            doc.render({
                ...
                result: data.result,
                authors: documentService.createAuthors(data.authorNumbers, data.authorFIOs, data.authorWorkplaces, data.authorWorkPositions, data.authorYearsBirh, data.contributions, data.percentageContributions),
